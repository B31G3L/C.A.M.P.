...
class CAMPApp:
    ...
    def _get_toolbar_callbacks(self):
        ...
        return {
            ...
            "markdown_manager": self._show_markdown_modal,
    ...
    def _create_markup(self):
        """
        Callback für den 'Create Markdown' Button
        Erstellt Markdown und ruft die Show-Methode auf
        """
        ...
        try:
            ...
            # Zeige das Markdown-Modal an
            self._show_markdown_modal(markdown_text)
            
        except Exception as e:
            print(f"Fehler beim Erstellen des Markdowns: {e}")
            self.main_view.show_message(f"Fehler beim Erstellen des Markdowns: {e}")
    
    def _show_markdown_modal(self, markdown_text):
        """
        Zeigt das Markdown-Modal mit dem übergebenen Markdown-Text an
        
        Args:
            markdown_text: Der anzuzeigende Markdown-Text
        """
        try:
            # Teste mit einer einfachen Nachricht, falls es Probleme mit der Markdown-Generierung gibt
            ...
            # Bei Fehlern mit dem Modal einfache Textmeldung ausgeben
            print(f"Fehler beim Öffnen des Markdown-Modals: {modal_error}")
            self.main_view.show_message(f"Fehler beim Öffnen des Markdown-Modals: {modal_error}")
